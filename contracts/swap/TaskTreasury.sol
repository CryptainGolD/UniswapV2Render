...
import {_transfer, ETH} from "../libraries/Transfer.sol";
...
contract TaskTreasuryMatic is Ownable, ReentrancyGuard {
    ...
    address payable public immutable core;
    ...
    constructor(address payable _core, address initialOwner) Ownable(initialOwner) {
        core = _core;
        maxFee = 1 ether;
    }
    ...
    function useFunds(
        ...
        _transfer(core, _token, _amount);
    }

    // Governance functions

    /// @notice Add new service that can call useFunds. Core Governance
    ...
    /// @notice Remove old service that can call useFunds. Core Governance
    ...
    /// @notice Change maxFee charged by Core (only relevant on Layer2s)
